...
function initCertificateModal() {
    ...
    const certificates = [
        ...
        {
            title: "Python for Data Sciencee",
...
function initBackgroundMusic() {
    ...
    source.src = 'Songs/Vaari Jaavan Dhurandhar The Revenge 320 Kbps.mp3';
